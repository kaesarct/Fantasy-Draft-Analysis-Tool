...
from app.routers import players, teams, league, injuries, matches, sync, history, serie_a_injuries, auth, player_merge, team_merge, trades, winter_market, player_stats_archive, awards, leghe_sync
